...
//
// This is the precondition for calling validateUTF8BlocksAVX2.
// On any machine that fails the check, [Valid] stays on the stdlib scalar path and the AVX2 instructions are never
// executed.
